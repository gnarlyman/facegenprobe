...
#define VER_COMPANYNAME_STR         "gnarlyman"
#define VER_FILE_DESCRIPTION_STR    "FaceGen storm-event logger for the Oblivion Script Extender"
...
#define VER_PRODUCTNAME_STR         "StormLog"
#define VER_PRODUCT_VERSION         VER_FILE_VERSION
#define VER_PRODUCT_VERSION_STR     VER_FILE_VERSION_STR
#define VER_ORIGINAL_FILENAME_STR	VER_PRODUCTNAME_STR ".dll"
#define VER_INTERNAL_NAME_STR       VER_ORIGINAL_FILENAME_STR

#define VER_COPYRIGHT_STR           "Copyright gnarlyman (C) 2026"
