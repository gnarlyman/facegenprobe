// FaceGenProbe.cpp
// Build 15: E8 zero/restore + return-address logging to identify re-scheduling call sites.
// Logs the return address for each mounted NPC Filler invocation to find WHICH
// call site keeps re-invoking the Filler in the storm loop.
...
bool InstallFaceGenHooks()
{
    ...
    RTLog::Write("[INIT] FaceGenProbe hooks installed (Filler caller-logging + 43b990)");
